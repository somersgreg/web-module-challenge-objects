...
function createMenuItem(name, price, category) {
  ...
  console.log("createMenuItem -> menu", menu)
  return menu;
}
// console.log("createMenuItem -> menu", menu)
...
// I DIDNT KNOW I HAVE TO CREATE AN EMPTY OBJECT
// I DONT KNOW HOW TO PRINT A RESULT USING THE MENU OBJECT IN A CONSOLE LOG
/* Task 1b: use your function to create 3 more menu items. You may add any items to the menu that you'd like */
createMenuItem("Hot Dog", 11, "Lunch");
createMenuItem("Coke", 7, "Drinks");
